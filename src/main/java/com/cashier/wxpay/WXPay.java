...
public class WXPay {
    ...
    public Map<String, String> fillRequestData(Map<String, String> reqData) throws Exception {
        ...
        System.out.println("WXPay.fillRequestData():统一下单map参数》》》》"+reqData);
        return reqData;
    }
    ...
    public String requestWithoutCert(String urlSuffix, Map<String, String> reqData,
    	...
    	System.out.println("WXPay.requestWithoutCert():reqData:"+reqData);
        String msgUUID = reqData.get("nonce_str");
        String reqBody = WXPayUtil.mapToXml(reqData);
        System.out.println("WXPay.requestWithoutCert()统一下单的xml参数：》》》》》》》》》》》》》》》》》》》》》》》》》\n》》》："+reqBody);
    ...
    public Map<String, String> unifiedOrder(Map<String, String> reqData) throws Exception {
    	...
    	System.out.println("WXPay.unifiedOrder()"+reqData);
    	Map<String, String> map = this.unifiedOrder(reqData, config.getHttpConnectTimeoutMs(), this.config.getHttpReadTimeoutMs());
    	System.out.println("WXPay.unifiedOrder():map:"+map);
    	return map;
    }
    ...
    public Map<String, String> unifiedOrder(Map<String, String> reqData,  int connectTimeoutMs, int readTimeoutMs) throws Exception {
        ...
        System.out.println("WXPay.unifiedOrder():url:"+url);
        String respXml = this.requestWithoutCert(url, this.fillRequestData(reqData), connectTimeoutMs, readTimeoutMs);
        System.out.println("WXPay.unifiedOrder():"+respXml);
        return this.processResponseXml(respXml);
    }
